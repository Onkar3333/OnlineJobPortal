					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Solapur, <br/> Government Polytechnic, <br/>Boys Hostel</address>
								</li>
								<li>
										<h5>Email</h5><a href="onkarbansode3333@gmail.com">onkarbansode3333@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+8956446484">+8956446484</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p>Nightingale Jobs is a job portal, online job management system developed by Onkar Bansode for his project in April 2023.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<address> Solapur, <br/> Government Polytechnic, <br/>Boys Hostel</address><br>
								<p>Email : <a href="onkarbansode3333@gmail.com">onkarbansode3333@gmail.com</a></p>
								<p>Phone : <a href="tel:+8956446484">8956446484</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Onkar Bansode</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Onkar Bansode</a></li>
								</ul>
